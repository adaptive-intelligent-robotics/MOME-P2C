...
class QualityPGConfig:
    ...
    objective_function_index: int = 1
...
class QualityPGEmitter(Emitter):
    ...
    def __init__(
        ...
        self._policy_loss_fn, self._critic_loss_fn = make_td3_loss_fn(
            ...
            reward_scaling=self._config.reward_scaling[self._config.objective_function_index],
            discount=self._config.discount,
            noise_clip=self._config.noise_clip,
            policy_noise=self._config.policy_noise,
            objective_function_index=self._config.objective_function_index,
        )
